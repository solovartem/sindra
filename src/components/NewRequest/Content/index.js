...
const NewRequestContent = ({ toggleError, setValidateRef }) => {
  const [activeTab, setActiveTab] = useState("Basic Details");
  const [tabsHasErrors, setTabsHasErrors] = useState([]);
  const [
    investmentPlatformsFromStrategies,
  ...
  const tabs = [
    {
      ...
      tab: (
        <span>
          {tabsHasErrors.includes("Basic Details") && (
      ...
      component: (
        <BasicDetails
          ...
          tabHasErrors={tabsHasErrors.includes("Basic Details")}
          validateBasicDetails={validateBasicDetails}
        />
      ),
    },
    {
      ...
      tab: (
        <span>
          {tabsHasErrors.includes("Recommended Strategies") && (
            <InfoCircleOutlined style={{ color: "red" }} />
          )}
    ...
    },
    {
      ...
      tab: (
        <span>
          {tabsHasErrors.includes("Investment Products") && (
            <InfoCircleOutlined style={{ color: "red" }} />
          )}
          Investment Products
        </span>
    ...
    },
    {
      ...
      tab: (
        <span>
          {tabsHasErrors.includes("Insurance Products") && (
            <InfoCircleOutlined style={{ color: "red" }} />
          )}
          Insurance Products
        </span>
    ...
    },
    {
      ...
      tab: (
        <span>
          {tabsHasErrors.includes("Ancilliary") && (
            <InfoCircleOutlined style={{ color: "red" }} />
          )}
          Ancillary
        </span>
      ...
      component: (
        <Ancilliary
          setTabsHasErrors={setTabsHasErrors}
          validateAnciallary={validateAnciallary}
          tabHasErrors={tabsHasErrors.includes("Ancilliary")}
        />
      ),
    },
  ];
